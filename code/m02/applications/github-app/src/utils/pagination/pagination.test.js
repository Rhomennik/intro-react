...
test('pagination({ total: "abc" , activePage: 1 }) should return should trow an error', () => {
  const params = { total: 'abac', activePage: 1 }
...
test('pagination({ total: 10 , activePage: "1a" }) should return should trow an error', () => {
