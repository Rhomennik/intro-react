...
it('reduce should a be a function', () => {
...
it('reduce([1, 2], (acc, item) => { acc["number-" + item] = item; return acc}, {}) {"number-1": 1, "number-2": 2}', () => {
...
// ReduceRiht
it('reduceRightRecursive(["do", "nan", "fer"], (acc, item) => acc + item, ,, should return "fernando" ', () => {
    const before = reduceRightRecursive(['do', 'nan', 'fer'], (acc, item) => acc + item, '')
